...
parser.add_argument('--path', type=str, help= f'models/Pong-v0_best.pt.', default=f'models/1.pt')
...
def save_frames_as_gif(frames, path='./', filename='gym_animation.gif'):
  ...
  #Mess with this to change frame size
    plt.figure(figsize=(frames[0].shape[1] / 72.0, frames[0].shape[0] / 72.0), dpi=60)
