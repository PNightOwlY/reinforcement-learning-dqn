...
def optimize(dqn, target_dqn, memory, optimizer):
    ...
    batch_s = torch.stack(sample[0]).view(32,4)
    batch_a = torch.stack(sample[1]).view(32,1)
    batch_s_ = torch.stack(sample[2]).view(32,4)
    batch_r = torch.stack(sample[3]).view(32,1)
    batch_done = torch.stack(sample[4]).view(32,1)
