...
# every 10000 frames, we average the ten recent rewards
...
if __name__ == '__main__':
  ...
  # Initialize environment and config.
    ...
    # comment this if we need win Replay Memory
    ...
    while(dqn.step < env_config['total_frames']):
        ...
        while not done:
          ...
          # evaluate the current model is time consuming, so we simply averaging the ten recent episodes reward.
